...
export default function NavBar({ component: RouteComponent, portfolioValue, stock, crypto, newsFeed, loadData}) {
  ...
  return (
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        <Toolbar />
        <RouteComponent portfolioValue={portfolioValue} stock={stock} crypto={crypto} loadData={loadData} newsFeed={newsFeed}/>
      </main>
    </div>
  );
}
